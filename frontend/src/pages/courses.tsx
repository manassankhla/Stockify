...
const courses = () => {
    ...
    const cardData = [
        { title: "Beginner", route: "/courses/beginner" },
        { title: "Intermediate", route: "/courses/intermediate" },
        { title: "Advanced", route: "/courses/advance" },
        { title: "How to Buy Stock", route: "/courses/how-to-buy" },
    ];
        ...
        <>
            <div className="min-h-screen flex flex-col items-center justify-center p-6"
             style={{
                ...
                <h1 className="text-4xl font-extrabold mb-8 text-black">Learning is Earning</h1>
